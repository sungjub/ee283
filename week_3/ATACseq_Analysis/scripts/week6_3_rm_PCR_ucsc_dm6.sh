...
# directory variables
pathToData="/pub/sungjub/ee283/week_3/ATACseq_Analysis/results/ucsc_dm6"
pathToOutput="/pub/sungjub/ee283/week_3/ATACseq_Analysis/results/ucsc_dm6/post_alignment"
